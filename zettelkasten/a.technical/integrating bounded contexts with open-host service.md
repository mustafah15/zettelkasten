...
tags:
  - book-notes
  - ddd
parent: "[[integrating bounded context with customer-supplier pattern]]"
aliases:
  - open-host service pattern
type: literature
---
### Open Host Service 
This pattern is the final type of [[integrating bounded context with customer-supplier pattern]] as this addresses the case in which the power is skewed toward the consumers the supplier is interested in protecting its consumers and providing the best service possible. 
