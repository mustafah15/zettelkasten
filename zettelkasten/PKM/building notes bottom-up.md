...
---
- note sequences are the backbone of text development a pure topic-related order would have to be organized top-down and requires a hierarchical order upfront, but a loose order of sequence allows freedom to change course when necessary and provides enough structure to build up complexity
